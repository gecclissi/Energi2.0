          ...
          <Stack spacing={4}>
            <FormControl id="firstName" isRequired>
              ...
              {form.nome.hasChanged && !form.nome.value && (
                <Text color={"red"} data-testid="nome-required">
                  Nome e obrigatorio
                </Text>
              )}
            </FormControl>
            <FormControl id="email" isRequired>
              ...
              {form.email.hasChanged && !form.email.value && (
                <Text color={"red"} data-testid="email-required">
                  Email e obrigatorio
                </Text>
              )}
              {form.email.hasChanged && !isEmailValid(form.email.value) && (
                <Text color={"red"} data-testid="email-invalid">
                  Email e invalido
                </Text>
              )}
            </FormControl>
            <FormControl id="password" isRequired>
              ...
              {form.senha.hasChanged && !form.senha.value && (
                <Text color={"red"} data-testid="senha-required">
                  Senha e obrigatorio
                </Text>
              )}
            </FormControl>
            <FormControl id="password2" isRequired>
              ...
              <InputGroup>
                <Input
                  ...
                  type={showPassword ? "text" : "password"}
                  value={form.senha2.value}
                  data-testid="senha2-required"
                  onChange={(event) =>
                    setForm({
                      ...form,
                      senha2: { hasChanged: true, value: event.target.value },
                    })
                  }
                />
                <InputRightElement h={"full"}>
              ...
              {form.senha2.hasChanged && !form.senha2.value && (
